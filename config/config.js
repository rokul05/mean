...
var initGlobalConfigFiles = function (config, assets) {
  ...
  config.files.client.js = getGlobbedPaths(assets.client.lib.js, 'public/').concat(getGlobbedPaths(assets.client.js, ['public/'])).concat(getGlobbedPaths(assets.client.templates, 'public/'));
